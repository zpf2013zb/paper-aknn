...
// AdjList record the adjacency information of nodes
// EdgeMap record the relationship between nodes and edge
void ReadRealNetwork(std::string prefix_name,int _NodeNum = 0)
{
	...
	// generate NodeNum list to record the adjacent nodes
...
// get a pair of nodes of an edge randomly
...
// output the binary of keywrod set represented by n
...
// generage the outlier num:NumPoint, kwd:avgKeywords on the edge randomly
...
// test the connect of real network
